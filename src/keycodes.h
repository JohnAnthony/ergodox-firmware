// USB HID keyboard usage page (0x07) key codes and short names.
// Merged from the original lib/usb/usage-page/keyboard.h and keyboard--short-names.h.
...
// Media key codes (translated to 16-bit consumer page codes in usb_keyboard)
